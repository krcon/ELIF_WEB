    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if(auth != null) {
			...
			if(requestedMenu != null) {
				String[] execCondition = {"/mgmt/product","/mgmt/board", "/mgmt/user","/mgmt/grant","/mgmt/log", "/mgmt/popup", "/mgmt/customer", "/mgmt/product"};
				if(Arrays.stream(execCondition).anyMatch(requestedMenu::contains)) {
					String menuName = "";
			        ...
			        if(exeSaveLog) {
				        ...
				        log.info("# USERNAME:" + principal.getUserid());
				        log.info("# LOGIN_IP:" + principal.getLogin_ip());
				        log.info("# ACCESS_MENU:" + menuName);
