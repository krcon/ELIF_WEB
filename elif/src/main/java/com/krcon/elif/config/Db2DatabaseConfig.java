...
@Configuration
@MapperScan(value="mappers_db2", sqlSessionFactoryRef="db2SqlSessionFactory")
...
public class Db2DatabaseConfig {
    ...
    public SqlSessionFactory db2SqlSessionFactory(@Qualifier("db2DataSource") DataSource db2DataSource, ApplicationContext applicationContext) throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(applicationContext.getResources("classpath:mappers_db2/*.xml"));
