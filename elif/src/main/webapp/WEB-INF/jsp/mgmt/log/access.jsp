	...
	<div class="wrapper " data-menu="/mgmt/log">
		...
		<div class="main-panel">
			<jsp:include page="../include/top.jsp">
				...
				<jsp:param name="sub" value="access" />
			</jsp:include>
			<!-- End Navbar -->
			<div class="content">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header card-header-icon card-header-rose">
									...
									<h4 class="card-title ">운영자 로그 기록</h4>
								</div>
								<div class="card-body">
									<ul class="nav nav-pills nav-pills-warning mt-3 mb-3" role="tablist">
										<li class="nav-item">
											<a href="/mgmt/log" class="nav-link active show">
											접속 기록
											</a>
										</li>
										<li class="nav-item">
									...
									<table class="table table-striped responsive-utilities jambo_table bulk_action">
										<thead>
											<tr class="headings">
												...
												<th width="15%" class="column-title text-center">구분 </th>
												<th width="10%" class="column-title text-center">IP </th>
												<th width="15%" class="column-title text-center">로그인/로그아웃 일시 </th>
											</tr>
										</thead>
										<tbody>
										 <c:choose>
											<c:when test="${fn:length(list) > 0}">
												...
												<c:forEach items="${list }" var="row">
													<tr>
														...
														<td class="text-center">
														<c:choose>
															<c:when test="${row.login_type=='login'}">
															로그인
															</c:when>
															<c:otherwise>
															로그아웃
														...
														<fmt:formatDate var="login_dtm" pattern="yyyy-MM-dd HH:mm:ss" value="${row.login_dtm }"/>
