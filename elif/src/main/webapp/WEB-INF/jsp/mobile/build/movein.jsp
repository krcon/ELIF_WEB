                ...
                <div class="contents_wrap">
                    ...
                    <section class="search_wrap">
                        ...
                        <div class="search_top">
                            <div class="find">
                                <label for="sch" class="a11y_hide">단지명 또는 지역명으로 검색</label> <!-- 1008 : label 추가 -->
                    ...
                    <section class="sale_list">
                        ...
                        <div>
                            <ul>
                                <!-- 
                                    [D] 1005 : 입주예정 시 i 태그에 클래스 no-data 추가
                                    <div class="tit"><em>포항 초곡 엘리프</em> <i class="flag type1 no-data">입주예정</i></div>
                                -->
                            </ul>
                            <!-- [D] li 기본 9개 노출 -->
