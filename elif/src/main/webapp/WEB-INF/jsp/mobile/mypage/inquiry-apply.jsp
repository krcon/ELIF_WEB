                        ...
                        <form name="frmSubmit" method="post" action="" class="form-inline text-right navbar-form">
                                    ...
                                    <ul class="info_list">
                                        <li class="info_item">
                                            <div class="info_label">
                                                <label for="type" class="tit ess">문의 구분</label>
                                            </div>
                                            <div class="info_type">
                                        ...
                                        <li class="info_item">
                                            <div class="info_label">
                                                <label for="name" class="tit ess">단지명</label>
                                            </div>
                                            <div class="info_type">
                                        ...
                                        <li class="info_item">
                                            <div class="info_label">
                                                <label class="tit ess" for="tit">제목</label>
                                            </div>
                                            <div class="info_type">
                                        ...
                                        <li class="info_item">
                                            <div class="info_label">
                                                <label for="cont" class="tit ess">내용</label>
                                            </div>
                                            <div class="info_type">
                            ...
                            <section class="cont_section la_mg">
                                ...
                                <div class="personal_info_box">
                                    <p>문의 내역 상담 진행을 위하여, 귀하의 개인정보를 수집, 이용하는데 있어 귀하의 동의를 받고자 합니다.</p>
                                    ...
                                    <p>위 개인정보 수집 및 이용에 대해서 미동의할 수 있으나, 이 경우 고객 문의 상담이 진행 될 수 없음을 알려드립니다.</p>
                                </div>
