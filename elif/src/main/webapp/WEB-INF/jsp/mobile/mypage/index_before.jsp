                ...
                <div class="contents_wrap">
                    ...
                    <section class="cont_section">
                        <div class="index_item">
                            <div class="myitem_head">
                                <p class="title1">나의 분양 단지</p><!-- [D] 0915 : 띄어쓰기 -->
                                ...
                                <ul class="myitem_list">
                                    <li>
                                        <a href="#" class="my_link">
                                            <span class="cate">아파트</span>
                                            <div class="cate_name">제천강저리슈빌NHF아파트</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="my_link">
                    ...
                    <section class="cont_section la_mg">
                        <div class="index_item">
                            <div class="myitem_head">
                                ...
                                <a href="#" class="plus_link"><span class="blind">분양대금 조회 더보기</span></a>
                            </div>
                            <div class="myitem_body">
                        ...
                        <div class="index_item">
                            ...
                            <div class="myitem_body">
                                <ul class="inquiry_list">
                                    <li>
                                        <a href="#">
                                            <span class="cate">홈페이지 문의</span>
                                            <!-- [D] 0914 : class .inquiry_tit 삭제 -->
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <span class="cate">홈페이지 문의</span>
                                            <!-- [D] 0914 : class .inquiry_tit 텍스트 삭제 -->
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                    ...
                    <section class="cont_section la_mg">
                        <div class="index_item">
                            ...
                            <div class="myitem_body">
                                <ul class="myitem_list with_date">
                                    <li>
                                        <a href="#" class="my_link">
                                            <span class="cate">아파트</span>
                                            <div class="cate_name">제천강저리슈빌NHF아파트
                    ...
                    <section class="cont_section la_mg">
                        <div class="index_item">
                            <div class="myitem_head">
                                ...
                                <a href="#" class="plus_link"><span class="blind">사전점검 방문 예약 내역 더보기</span></a>
                            </div>
                            <div class="myitem_body">
                                <ul class="myitem_list with_date">
                                    <li>
                    ...
                    <section class="cont_section la_mg">
                        <div class="index_item">
                            <div class="myitem_head">
                                ...
                                <a href="#" class="plus_link"><span class="blind">공지사항 내역 더보기</span></a>
                            </div>
                            <div class="myitem_body">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr class="notice">
                                                ...
                                                <td class="notice_tit">
                                                    <a href="#" class="title">
                                                        <span class="board_tit">홈페이지 가입은 어디에서 하면 되나요?홈페이지 가입은 어디에서 하면 되나요?</span>
                                                        <span class="list_date">2021년 7월 3일</span>
                                                    </a>
                                                </td>
                                            </tr>
                                            <tr>
