                                ...
                                <div class="guide_box">
                                    <%-- <ul class="guide_list number gap_wide">
                                        <li>
                                            ...
                                            <p class="guide_txt refer mt20">취득일 : <br>준공일(사용/임시사용승인일) 이전 잔금납부 시 준공일(사용/임시사용승인일)<br>
                                                준공일(사용/임시사용승인일) 이후 잔금납부 시 잔금납부일
                                            </p>
                                        </li>
                                        <li>
                                            <span class="num">2.</span>재산세 (지방세법 제107조, 제114조)
                                            <p class="guide_txt bar">재산세 과세기준일(매년6월1일) 현재 재산을 사실 상 소유(잔금납부일 또는 등기일 중 선행일)하고 있는 자는 재산세를 납부할 의무가 있습니다.</p>
                                        </li>
                                    </ul> --%>
