                                    ...
                                    <div class="info_type">
                                        <div class="address_input_wrap">
                                            <div class="input_row">
                                                ...
                                                <button type="button" onclick="openDaumAddr();" class="btn border" >우편번호 검색</button>
                                            </div>
                                            <div class="input_row">
                                                <label for="txt1" class="a11y_hide"></label>
                                                <input type="text" id="txt1" name="ftn_addr" id="address02" class="wxla" value="${member.ftn_addr}" readonly>
                                            </div>
                                            <div class="input_row">
                                                <label for="txt2" class="a11y_hide"></label>
                                                <input type="text" id="txt2" name="dtl_addr" id="address03" class="wxla" value="${member.dtl_addr}" placeholder="상세 주소를 입력해주세요.">
                                            </div>
                                            <span class="gray_smtxt gap">우편물 수령 시 주소 변경은 본사 분양관리부로 연락주시기 바랍니다.<br>TEL 070-4470-7901,7902</span>
                                        </div>
                                    </div>
                                </li>
                                <li class="info_item">
                    ...
                    <section class="cont_section la_mg">
                        ...
                        <div class="info_table">
                            <ul class="info_list">
                                ...
                                <li class="info_item depositline ${member.deptsit_yn=='Y'?'':'hide'}">
                                    <div class="info_label">
                                    ...
                                    <div class="info_type">
                                        ...
                                        <div class="muti_input_wrap">
                                            <select  name="deposit_yy" class="transparent_input" id="join01">
                                                <option value="">선택</option>
                                            ...
                                            <label for="join01" class="unit">년</label>
                                            <select  name="deposit_mm" class="transparent_input" id="join02">
                                                <option value="">선택</option>
                                            ...
                                            <label for="join02" class="unit">월</label>
                                        </div>
                                    </div>
                                </li>
                            </ul>
