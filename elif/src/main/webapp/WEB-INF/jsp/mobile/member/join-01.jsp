...
<body>
                ...
                <div class="contents_wrap">
                    <section class="cont_section">
                        <div class="step_list_wrap">
                            <ol class="step_list">
                                <li class="on"><span class="step"><em>step1 약관 동의</em></span></li>
                                <li><span class="step"><em>step2 본인 인증</em></span></li>
                    ...
                    <section class="cont_section">
                        ...
                        <div class="term_box">
                            <div class="term_header">
                                <span class="ch_wrap">
                                    ...
                                    <label for="all_agree">약관 전체 동의하기</label>
                                </span>
                            </div>
                            <div class="term_body">
                                <ul class="term_list">
                                    <li> <!-- class on toggle -->
                                        <div class="list_header">
                                            <span class="ch_wrap">
                                                <input type="checkbox" id="agree_01" name="agree01" value="Y">
                                                <label for="agree_01">이용약관</label>
                                            </span>
                                            <button type="button" class="btn border sm">약관 보기</button> <!-- on toggle -->
                                        </div>
                                        <div class="list_body">
                                            <div class="gray_box scroll">
                                                <!-- <p class="term_tit2">제 1 조 (목적)</p>
                                                <ul class="guide_list number">
                                                    <li>
                                                        <span class="num">1.</span>이 회원규칙 및 프라이버시(Privacy) 규정은 전기통신사업법 및 동법시행령에 의하여
                                                        계룡건설(이하 "회사"라 한다)이 제공하는 서비스(이하 "서비스 "라 한다 )의 이용조건, 절차 그리고 회원규칙에 관한
                                                        사항을 규정함을 목적으로 합니다.
                                                    </li>
                                                </ul>
                                                <p class="term_tit2">제 2 조 (공지 및 준용)</p>
                                                <ul class="guide_list number">
                                                    <li>
                                                        <span class="num">1.</span>이 규정의 내용은 서비스 화면에 게시하거나 기타의 방법으로 회원에게 공지함으로써 효력을 발생합니다.
                                                    </li>
                                                    <li>
                                                        <span class="num">2.</span>회사는 이 규정을 변경할 수 있으며, 변경된 규정은 제1항과 같은 방법으로 공지함으로써 효력을 발생합니다.
                                                    </li>
                                                </ul> -->
                                                                <!-- 제 1장 -->
                                                ...
                                                <ul class="guide_list number">
                                                    <li><span class="num">①</span>본 약관은 사이트에 게시하거나 SNS 등 기타의 방법으로 이용자에게 공지함으로써 효력이 발생합니다.</li>
                                                ...
                                                <ul class="guide_list number">
                                                    <li>
                                                        ...
                                                        <ol>
                                                            <li>이용자는 서비스에 접속하여 본 약관에 따라 제공되는 서비스를 받는 회원(일반회원/계약회원) 및 비회원을 말합니다.</li>
                                                            <li>일반회원이라 함은 회사와 계약관계가 없는 자로서, 회사에 개인정보를 제공하여 회원등록을 하고 회사의 정보를 지속적으로 제공받으며, 회사가 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.</li>
                                                            <li>계약회원이라 함은 회사와 계약관계가 있는 자로서, 일반회원이 이용할 수 있는 서비스와 함께 부가적인 서비스를 이용할 수 있는 자를 말합니다.</li>
                                                            ...
                                                            <li>비밀번호는 이용자의 이용자ID와 일치된 이용자임을 확인하고 이용자의 권익보호를 위하여 이용자가 선정한 문자, 숫자, 그리고 특수문자의 조합을 말합니다.</li>
                                                ...
                                                <ul class="guide_list number">
                                                    ...
                                                    <li><span class="num">③</span>회사는 서비스 제공과 관련해서 알고 있는 회원의 신상정보를 본인의 승낙 없이 제3자에게 누설, 배포하지 않습니다. 단, 전기통신기본법 등 법률의 규정에 의해 국가기관의 요구가 있는 경우, 범죄에 대한 수사상의 목적이 있거나 정보통신윤리위원회의 요청이 있는 경우 또는 기타 관계법령에서 정한 절차에 따른 요청이 있는 경우에는 그러하지 않습니다.</li>
                                                </ul>
                                                ...
                                                <ul class="guide_list number">
                                                    ...
                                                    <li><span class="num">②</span>제1항의 이용시간은 정기 점검 등의 필요로 인하여 당사가 정한 날과 시간 그리고 기간 통신사업자가 전기통신 서비스를 중지했을 때, 국가 비상사태, 천재지변, 정전, 네트워크망 장애, 서비스 설비의 장애 또는 서비스 이용의 폭주, 기타 불가항력의 요소 등으로 정상적인 서비스 이용에 지장이 있는 때는 그러하지 아니합니다.</li>
                                                ...
                                                <ul class="guide_list number">
                                                    <li><span class="num">①</span>회사는 회원이 서비스 이용 중 필요가 있다고 인정되는 다양한 정보에 대해서 전자우편, 유선매체, 서신우편, SMS, 카카오톡 및 기타 SNS 매체 등의 방법으로 회원에게 제공할 수 있습니다.</li>
                                                </ul>
                                                ...
                                                <ul class="guide_list number">
                                                    <li><span class="num">①</span>회사와 이용자간에 발생한 분쟁에 관한 소송의 관할법원인 대전지방법원에 제기합니다.</li>
                                    ...
                                    <li>
                                        <div class="list_header">
                                            <span class="ch_wrap">
                                                <input type="checkbox" id="agree_02" name="agree02" value="Y">
                                                <label for="agree_02">개인정보 처리 및 이용안내</label>
                                            </span>
                                            <button type="button" class="btn border sm">약관 보기</button> <!-- on toggle -->
                                        </div>
                                        <div class="list_body">
                                            <div class="gray_box scroll">
                                                ...
                                                <ul class="guide_list number">
                                                    ...
                                                    <li>
                                                        <span class="num">2.</span>회사는 이 규정을 변경할 수 있으며, 변경된 규정은 제1항과 같은 방법으로 공지함으로써
                                                        효력을 발생합니다.
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <div class="gray_box">
                            <ul class="guide_list number">
                                <li>
                                    <span class="num">1.</span>엘리프에서 제공하는 분양정보, 공사현장정보등을 문자, 이메일 등으로 제공 받으실 수 있습니다.
                                </li>
                                <li>
                                    <span class="num">2.</span>일반회원과 계약회원으로 구분됩니다. 일반회원은 분양정보를 등록하시면 계약회원으로 전환됩니다.
                                </li>
                                <li>
                                    <span class="num">3.</span>계약회원은 나의 분양정보를 통하여 중도금 납부 내역 조회 등의 서비스를 받으실 수 있습니다.
                                </li>
                                <!-- <li>
                                    <span class="num">4.</span>고객센터의 1:1상담서비스인 고객문의, A/S신청, 당첨자 조회 등의 서비스를 받으실 수 있습니다.
                                </li> -->
                            </ul>
                        </div>
                    </section>
    ...
    <script>
        // elif.saleSearch();
        /* [D] 0915 : 추가 : 공통으로 옮겨지면 삭제 중첩되면 이벤트 에러 발생 */
        var termViewBtn = $('.term_box .list_header .btn');
        termViewBtn.on('click', function(e){
    ...
    $("#all_agree").click(function(){
        if($("#all_agree").is(":checked")) $("input[name=agree]").prop("checked", true);
        else $("input[name=agree]").prop("checked", false);
    });

    $('#all_agree').on('change',function(){
        if($(this).is(':checked')){
            $('[name=agree01]').prop('checked',true);
            $('[name=agree02]').prop('checked',true);
        }else{
            $('[name=agree01]').prop('checked',false);
            $('[name=agree02]').prop('checked',false);
        }
    });

    $('[name=agree01],[name=agree02]').on('change',function(){
        if($('[name=agree01]').is(':checked')&&$('[name=agree02]').is(':checked')){
    ...
    function fn_Step01(obj){
        ...
        comSubmit.setUrl("${rpath}/member/join-02");
