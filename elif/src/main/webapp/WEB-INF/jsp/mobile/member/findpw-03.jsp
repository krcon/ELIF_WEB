            ...
            <div class="inner no_pd">
                <div class="login_box_wrap">
                    <div class="box_inner">
                        <h2>비밀번호 찾기</h2>
                        <div class="login_box">
                            <p class="login_txt">새로운 비밀번호를 입력해주세요.</p>
                            <form name="memberForm" id="memberForm" role="memberForm" method="post" action="findpw_03_proc">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                                <input type="hidden" name="user_id" value="${param.param_r1}">
                                <div class="input_row">
                                    <label for="psw_new1"></label> <!-- 1008 : label 추가 -->
                                    <input type="password" id="psw_new1" name="password" class="border_input" placeholder="신규 비밀번호"> <!--  1008 : id 추가 -->
                                    <p class="form_txt">8~14자리 이내로 영문 대소문자, 숫자, 특수문자 중 3가지 이상의 조합으로 입력해주시기 바랍니다. </p>
                                </div>
                                <div class="input_row">
                                    <label for="psw_new2"></label> <!-- 1008 : label 추가 -->
                                    <input type="password" id="psw_new2" name="password_confirm" class="border_input" placeholder="비밀번호 확인"> <!--  1008 : id 추가 -->
                                </div>
                                <div class="btn_area">
