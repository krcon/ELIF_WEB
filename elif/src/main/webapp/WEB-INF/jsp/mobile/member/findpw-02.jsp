...
<body>
    ...
    <form name="vnoform" method="post" action="${rpath}/member/findpw-03">
        ...
        <input type="hidden" name="param_r1" value="${param.user_id}">
        <input type="hidden" name="param_r2" value="${param.user_nm}">
