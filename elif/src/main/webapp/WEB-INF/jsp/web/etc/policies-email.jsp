        ...
        <main id="container">
            <div class="inner">
                ...
                <div class="contents_wrap">
                    <div class="error_box">
                        <i class="ico">
                            <img src="/resources/web/images/email_ico.svg" alt="">
                        </i>
                        <p class="tit">엘리프 웹사이트는 이메일 주소 수집을 거부합니다.</p>
                        <p class="box_txt">본 사이트에 게시된 이메일주소가 전자우편수집 프로그램이나 그 밖의 기술적 장치를 이용하여​<br>
                            무단으로 수집되는 것을 거부하며, 이를 위반시 정보통신망법에 의해 형사처벌됨을 유념하시기 바랍니다.</p>
