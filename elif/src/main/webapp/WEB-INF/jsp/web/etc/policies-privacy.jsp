            ...
            <div class="inner">
                ...
                <div class="contents_wrap">
                    <div class="info_select_wrap">
                        ...
                        <select class="border-select wla" name="privacy_select"  id="sch">
                        <c:choose>
                    ...
                    <section class="cont_section nomt">
                        <div class="guide_box">
                            <p class="guide_txt">
                                (주)계룡건설'은 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호에 관한 법률" 및 "개인정보보호법" 등
                                사업자가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보처리방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다. <br>
                                회사는 개인정보처리방침을 통하여 회원님들께 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
                            </p>
                        </div>
                        <div class="border_box guide_box term_box">
