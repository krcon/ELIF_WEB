...
<fmt:message key="sys.profile" var="sysprofile"/>
        ...
        <script src="/resources/web/js/story/jquery-3.4.1.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/3.1.2/vendors/scrolloverflow.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/3.1.2/fullpage.min.js"></script>
        <script src="/resources/web/js/story/ScrollMagic.min.js"></script>
        <script src="/resources/web/js/story/animation.gsap.min.js"></script>
        <script src="/resources/web/js/story/debug.addIndicators.min.js"></script>
        <script src="/resources/web/js/story/TweenMax.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/Swiper/4.5.1/js/swiper.min.js"></script>
        <script src="/resources/web/js/common.js"></script>
        <script src="/resources/web/js/story/story.js"></script>
        <script>
            elif.saleSearch();
        </script>
        <script>
