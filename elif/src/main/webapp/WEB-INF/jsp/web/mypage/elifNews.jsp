...
<body>
                ...
                <div class="contents_wrap">
                    ...
                    <nav class="lnb small">
                        <ul>
                            ...
                            <li><a href="../mypage/elifNews" class="on">엘리프 뉴스</a></li>
                    ...
                    <section class="cont_section">
                        <form name="frmSearch" action="elifNews" class="form-inline text-right navbar-form">
                        ...
                        <div class="info_table board">
                            <table class="table normal_table">
                                ...
                                <c:when test="${fn:length(list) > 0}">
                                    ...
                                    <tr class="${row.mainstatus=='Y'?'elifNews':''}">
                                        <td class="no_pds tc">
	...
	function fn_openBoardView(idx){
	    ...
	    comSubmit.setUrl("elifNews-view");
