                ...
                <div class="contents_wrap">
                    ...
                    <nav class="lnb small">
                        <ul>
                            ...
                            <li><a href="../mypage/FAQ-view" class="on">FAQ</a></li>
                            <li><a href="https://cs.kyeryong.net/jsp/as/defc/co/defc_co_confirm.jsp" target="_blank">A/S 신청</a></li>
                        </ul>
                    </nav>
                    <!-- //LNB-->
                    <section class="cont_section">
                        <form name="frmSearch" action="FAQ-view" class="form-inline text-right navbar-form">
