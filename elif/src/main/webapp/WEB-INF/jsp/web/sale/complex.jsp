...
<head>
    ...
    <meta name="title" content="분양단지,엘리프" content="분양단지,엘리프"/> 
    <meta name="keywords" content="분양단지, 아파트, 상가, 분양중, 분양 예정, 엘리프, 계룡건설 엘리프, ELIF, 분양, 공사, 입주, 프리미엄 주거 공간" content="분양단지, 아파트, 상가, 분양중, 분양 예정, 엘리프, 계룡건설 엘리프, ELIF, 분양, 공사, 입주, 프리미엄 주거 공간"/> 
    <meta name="description" content="엘리프의 분양 단지를 안내해드립니다. " content="엘리프의 분양 단지를 안내해드립니다. "/>
        ...
        <main id="container">
            <div class="inner">
                ...
                <div class="contents_wrap">
                    ...
                    <nav class="lnb">
                        <ul>
                            <li><a href="../sale/complex" class="on">분양 단지</a></li>
                    ...
                    <section class="sale_list">
                        <ul>
                            <!-- 
                                [D] 0930 : 등록페이지 없을시 i태그에 no-data 클래스 추가
                                <div class="tit"><em>포항 초곡 엘리프</em> <i class="flag type1 no-data">분양중</i></div>
                             -->
                        </ul>
                        <div class="btn_more">
