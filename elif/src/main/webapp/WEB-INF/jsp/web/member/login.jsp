                    ...
                    <div class="box_inner">
                        ...
                        <div class="login_box">
                            ...
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                                <div class="input_row">
                                    <label for="uid" class="a11y_hide">아이디</label> 
                                    <input type="text" name="user_id" class="border_input" value="${sessionScope.sessionRequest eq null?'':sessionScope.sessionRequest.user_id}" placeholder="아이디" id="uid" autocomplete="off">
                                </div>
                                <div class="input_row">
